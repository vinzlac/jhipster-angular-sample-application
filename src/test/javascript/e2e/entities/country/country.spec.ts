...
describe('Country e2e test', () => {
  ...
  it('should load Countries', async () => {
    ...
    expect(await countryComponentsPage.getTitle()).to.eq('jhipsterSampleApplication2App.country.home.title');
  ...
  it('should load create Country page', async () => {
    ...
    expect(await countryUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplication2App.country.home.createOrEditLabel');
  ...
  it('should delete last Country', async () => {
    ...
    expect(await countryDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplication2App.country.delete.question');
