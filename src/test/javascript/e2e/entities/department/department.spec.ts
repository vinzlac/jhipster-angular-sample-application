...
describe('Department e2e test', () => {
  ...
  it('should load Departments', async () => {
    ...
    expect(await departmentComponentsPage.getTitle()).to.eq('jhipsterSampleApplication2App.department.home.title');
  ...
  it('should load create Department page', async () => {
    ...
    expect(await departmentUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplication2App.department.home.createOrEditLabel');
  ...
  it('should delete last Department', async () => {
    ...
    expect(await departmentDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplication2App.department.delete.question');
